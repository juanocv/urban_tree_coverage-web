...
const DICT = {
  pt: {
    ...
    "help.auth": "Para acessar de qualquer lugar, ligue a autenticação e exponha a API por HTTPS — um túnel da Cloudflare faz isso sem IP público nem abrir portas:",
  ...
  en: {
    ...
    "help.auth": "To reach it from anywhere, turn on authentication and expose the API over HTTPS — a Cloudflare tunnel does that without a public IP or an open port:",
